...
export default function HeroSection() {
  return (
    <main className="flex-1 flex bg-[#F6E2BFFF] md:mr-64 min-h-screen">
      ...
      {/* Bagian teks kanan */}
      <div className="w-full md:w-2/4 flex flex-col justify-center p-6 md:p-12 text-left md:text-right bg-[#F6E2BFFF]">
        <q
          className={`text-6xl font-bold leading-tight mb-3 text-[#546A51] sm:pt-0 pt-24 italic ${fiveyearsold.className}`}
        >
